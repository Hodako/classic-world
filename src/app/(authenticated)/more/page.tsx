...
const businessLinks = [
  ...
  { to: "/employees",      labelKey: "employees" as any, desc: "Employee accounts, salary ledger, expenses & shopping draws", icon: Users, perm: "settings" as const },
            ...
            <div className="space-y-4 my-auto h-full flex flex-col justify-center text-center px-2">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-xs text-foreground">
                  {lang === "bn" ? "ক্লাসিক ওয়ার্ল্ড অডিট এজেন্টের সাথে চ্যাট করুন" : "Chat with Classic World Audit Agent"}
                </h4>
